...
export default function SuggestionsList({ suggestions, onSelect, loading }) {
  return (
    <div className="grid gap-2 sm:grid-cols-2">
      {suggestions.map((s, i) => (
        <Button
          ...
          className="h-auto w-full flex-col items-start justify-start gap-1 whitespace-normal rounded-xl px-4 py-3 text-left disabled:opacity-50">

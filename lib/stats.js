...
export function computeStreak(reviewTimestamps, frozenDates = []) {
...
export function computeStats(reviewLogs, cards, frozenDates = []) {
  ...
  const streak = computeStreak(reviewLogs.map((r) => r.review), frozenDates)

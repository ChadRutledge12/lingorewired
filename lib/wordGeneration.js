...
const TIER_GUIDANCE = `Tier meanings:
- "universal": high-frequency words — but pick ones the learner would actually reach for while talking about their own interests and contexts (the verbs, connectors, question words, and descriptors that glue their specific vocabulary into real sentences), NOT a generic textbook frequency list.
- "environment": words for the specific situations/places in their daily contexts.
- "domain": words from their particular interests, work, or field.
...
Vary your choices — do not default to the same common universal words every time; tailor them to this learner.

...
export const WORD_FIELDS_SPEC =`- "word": the Spanish term. For NOUNS, always include the definite article that matches gender and number ("el aeropuerto", "la reunión", "los guantes", "las llaves") so the gender is unambiguous. Do NOT add an article to non-nouns (verbs, adjectives, etc.).
